const products = {
    comidamexicana: [
        ...
        { name: "Taco de pierna de cerdo (ahumada, lengua)", price: 5.50, image: "tacocerdo.png" },
        { name: "Taco de Res", price: 4.50, image: "tacores.jpg" },
        { name: "Taco al pastor", price: 4.50, image: "tacopastor.jpg" },
        { name: "Taco de adobado", price: 4.50, image: "tacoadobado.jpg" },
        { name: "Taco de pollo", price: 4.50, image: "tacopollo.jpg" },
        { name: "Taco de chorizo", price: 4.50, image: "tacochorizo.jpg" },
        { name: "Taco mixto", price: 4.50, image: "tacomixto.jpg" },
        ...
        { name: "Burrito al pastor", price: 5.00, image: "burritopastor.jpeg" },
        { name: "Burrito de adobado", price: 5.00, image: "burritoadobado.jpg" },
        { name: "Burrito de pollo", price: 5.00, image: "burritopollo.jpg" },
        { name: "Burrito de res", price: 5.00, image: "burritores.jpg" },
        { name: "Burrito de chorizo", price: 5.00, image: "burritochorizo.jpg" },
        { name: "Burrito mixto", price: 5.00, image: "burritomixto.jpg" },
        ...
        { name: "Nachos de carne", price: 4.00, image: "nachos.jpeg" },
    ...
    bebidas: [
        ...
        { name: "Jugo de naranja", price: 2.00, image: "jugoanaranja.jpg" },
        ...
        { name: "Licuado de fresa", price: 2.00, image: "licuadofresa.jpg" },
        { name: "Licuado de coco", price: 2.00, image: "licuadococo.jpg" },
    ...
    birria: [
        { name: "Tacos de birria", price: 6.50, image: "tacobirria.jpg" },
        { name: "Torta de birria", price: 7.00, image: "tortabirria.jpg" },
        { name: "Burrito de birria", price: 7.00, image: "burritobirria.jpg" },
        { name: "Gringas de birria", price: 6.50, image: "gringasbirria.jpg" },
        { type: "separator", title: "(tacos) 4 unidades doble tortilla" },
    ],
    taquizas: [
        {type: "separator", title: "Taquizas para 3 personas"},
        { name: "16 tacos + 3 sodas", price: 20.00, image: "taquiza3.jpg" },
        {type: "separator", title: "Taquizas para 10 personas"},
        { name: "20 tacos + 4 sodas", price: 25.00, image: "taquiza4.jpg" },
        { type: "separator", title: "Taquizas para 5 personas"},
        { name: "24 tacos + 5 sodas + 1 sopa de tortilla", price: 40.00, image: "taquiza6.jpg" },
    ],
    combos: [
        { type: "separator", title: "Combo 1" },
        { name: "1 burrito + 2 tacos unidades + 1 soda", price: 8.00, image: "combo1.jpg" },
        { type: "separator", title: "Combo 2" },
        { name: "1 torta + 2 tacos unidades + 1 soda", price: 8.0, image: "combo2.jpg" },
        { type: "separator", title: "Combo 3"},
        { name: "4 tacos + 2 gringas cualquier especialidad + 1 soda", price: 7.50, image: "combo3.jpg" },
        { type: "separator", title: "Combo 4"},
        { name: "4 gringas + 2 tacos unidades + 1 soda", price: 8.00, image: "combo4.jpg" },
    ...
    platosfuertes: [
        { name: "Camarones al ajillo", price: 7.50, image: "camaronesajillo.jpg" },
        { name: "Carne a la parrilla", price: 5.00, image: "carneparrilla.jpg" },
        { name: "Alitas a la barbacoa", price: 5.00, image: "alitas.jpg" },
        { name: "Pechuga asada", price: 5.00, image: "pechugaasada.jpg" },
    ],
    platoseconomicos: [
        { name: "Cazamiento y chorizo (2 tortillas)", price: 2.50, image: "cazamientochorizo.jpg" },
        { name: "Cazamiento, chirmol aguacate (2 tortillas)", price: 2.50, image: "cazamientochirmol.jpg" },
        { name: "Frijoles platano y huevo (2 tortillas)", price: 2.50, image: "frijolesplatano.jpg" },
    ],
    detox: [
        {type: "separator", title: "Jugos desintoxicantes para tu organismo "},
        { name: "Zanahoria", price: 2.50, image: "zanahoria.jpg" },
